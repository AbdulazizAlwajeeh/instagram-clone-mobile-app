...
abstract class ChatRepository {
  ...
  /// Returns a [ServerFailure] on the left side if the stream cannot be initialized,
  /// or a [Stream] of [List<ChatEntity>] on the right side.
  ...
  /// Returns a [ServerFailure] on the left side, or the active [Chat] on the right side.
  ...
  /// Returns a [ServerFailure] on the left side, or a [Stream] of [List<Message>] on the right side.
  ...
  /// Returns a [ServerFailure] on the left side, or a structural confirmation [Unit] on the right side.
